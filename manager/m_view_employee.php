...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	  ...
	  <form action="m_update_employee.php" method="post" class="form-horizontal">
...
<script>
	...
	// {
		...
		// if(msg==true)
		// {
			// window.location.href="m_delete_employee.php?e_id="+id;
		// }else
		// {
			// window.location.href="m_view_employee.php";
		// }
	// }
	function edit_employee(id)
	{
		$.ajax({
			'url':'m_edit_employee.php',
			'data':'e_id='+id,
			'method':'get',
			'datatype':'json',
