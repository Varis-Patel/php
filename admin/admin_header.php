            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
						<li class="has-sub">
                            <a class="js-arrow" href="admin_main.php">
                                <i class="fas fa-home"></i>Home</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fa fa-user"></i>Manager</a>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
								...
								<li>
                                    <a  href="emp_perf.php">Performance</a>
                                </li>
                            </ul>
                        </li>
						<li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
								...
								<li>
                                    <a href="manager_assigned.php">Manager Assigned</a>
                                </li>
                            </ul>
                        </li>
						<li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fa fa-star"></i>Review & Rating</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="review.php">Details</a>
                                </li>
                                <li>
                                    <a href="average.php">Average Rating</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
