<?php
	...
	if(isset($_SESSION['e_id']) && $_SESSION['e_id']!="")
	{
		...
		$m_id=$_SESSION['e_manager_assign'];
                ...
                <div class="section__content section__content--p30">
					...
					<div class="card mb-0">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="e_insert_review.php" method="post" class="form-horizontal">
											...
											<input class="form-control" name="given_by" type="hidden" value="<?php echo "e-".$_SESSION['e_name']?>">
