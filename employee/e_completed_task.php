<?php
	...
	if(isset($_SESSION['e_id']) && $_SESSION['e_id']!="")
	{
		...
		$e_id=$_SESSION['e_id'];
		$select="SELECT epeac_task.*,epeac_addmanager.m_name,epeac_addemployee.e_name FROM epeac_task JOIN epeac_addmanager ON epeac_task.t_manager=epeac_addmanager.m_id JOIN epeac_addemployee ON epeac_task.t_employee=epeac_addemployee.e_id where t_employee='$e_id' && t_status='Completed'";
